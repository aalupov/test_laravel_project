		...
		<div class="col-md-12">
			<div class="card">
				...
				@include('includes.error') @include('includes.success')<br>
                   ...
                   <form method="post" action="{{ route('sections.update', $id) }}" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                             ...
                             @else
                               <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $sectionInfo->name }}" required autocomplete="name" autofocus>                                                       
                             @endif
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               @else
                                    <textarea class="form-control @error('description') is-invalid @enderror" aria-label="description" name="description" id="description" autocomplete="description" autofocus>{{ $sectionInfo->description }}</textarea>
                               @endif                             
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
