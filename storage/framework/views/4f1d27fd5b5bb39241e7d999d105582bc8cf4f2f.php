		...
		<div class="col-md-12">
			<div class="card">
				...
				<?php echo $__env->make('includes.error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php echo $__env->make('includes.success', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><br>
                   ...
                   <form method="post" action="<?php echo e(route('sections.update', $id)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($sectionInfo->name); ?>" required autocomplete="name" autofocus>                                                       
                             <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" aria-label="description" name="description" id="description" autocomplete="description" autofocus><?php echo e($sectionInfo->description); ?></textarea>
                               <?php endif; ?>                             
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paymentgw/data/www/api.ptzhost.net/test/resources/views/section/edit.blade.php ENDPATH**/ ?>